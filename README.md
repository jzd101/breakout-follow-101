...
- **RMA ATR Smoothing**: Custom ATR implementation (Wilder's Smoothing) to ensure mathematical alignment across all platforms.
...
- **Smart Risk Control**: Integrated compounding risk, daily loss protection, max trade constraints, and volume filtering.
...
3. **Visuals**: Displays clean, borderless TP/SL boxes synchronized with active strategy trades.
