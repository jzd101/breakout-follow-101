...
def run_backtest(df, initial_capital=1000, risk_pct=2.0, rr=2.0, use_ema=True, use_vol=True, atr_mult=2.0, compound=False, max_trades=1, daily_loss_limit=0.0, start_hour=7, end_hour=20):
